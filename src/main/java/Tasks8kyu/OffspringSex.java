...
XX or female. If the sperm cell contains a Y chromosome, then the resulting
...
public class OffspringSex {
    public static String chromosomeCheck(String sperm) {
        if(sperm == null) return "Sperm chromosome is not found. Please, check the input parameter.";
        switch (sperm) {
            case "XX": return "Congratulations! You're going to have a daughter.";
            case "XY": return "Congratulations! You're going to have a son.";
            default: return "Sperm chromosome cannot be recognized. Please, check the input parameter.";
        }
    }
    public static void main(String[] args) {
        System.out.println(chromosomeCheck("XX"));
        System.out.println(chromosomeCheck("XY"));
        System.out.println(chromosomeCheck("X"));
        System.out.println(chromosomeCheck(null));
    }
}
